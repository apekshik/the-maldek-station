...
bpy.ops.import_scene.fbx(filepath=str(out/'fbx/SM_Maldek_Tapered_Pylon.fbx'))
...
report={'fbx_reimported':True,'mesh_count':1,'bounds_m':[lo,hi],'materials':[m.name for m in ob.data.materials],'sampled_cabin_poses':c['poses_checked'],'illustrative_swing_degrees':c['illustrative_body_swing_degrees'],'mesh_intersections':0,'unreal_integration':'pending','weathering_transfer':'Procedural Blender shaders require baking or recreation in Unreal'}
