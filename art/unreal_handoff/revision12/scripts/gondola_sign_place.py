...
a.set_actor_location(unreal.Vector(a.get_actor_location().x,a.get_actor_location().y,sum(heights)/len(heights)),False,True)
sight=[]
for eye in [start+unreal.Vector(1000,-450,170),start+unreal.Vector(1800,-500,170)]:
 for x,z in [(-115,48),(115,48),(-115,120),(115,120),(0,79)]:
