...
h.OUT=out;h.SOURCE=root/'art/blender/gondola_status_sign_02/Maldek_Gondola_Status_Sign.blend';h.EXPECTED=hashlib.sha256(h.SOURCE.read_bytes()).hexdigest()
...
boxes=[box((0,.06,.79),(2.67,.32,1.37))]+[box((x,.07,.12),(.28,.38,.24)) for x in [-.92,.92]]
