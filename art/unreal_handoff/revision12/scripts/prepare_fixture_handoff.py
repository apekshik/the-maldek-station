...
labels+=['R09_Cabin_Ceiling_Housing','R09_Cabin_Ceiling_Diffuser']
rows=[]
for label in labels:
 r=inventory[label];assert len(r['components'])==1
 c=r['components'][0]
 t={'actor':r['r12_path'],'component':c['name'],'old_mesh':c['mesh'],'stage':'Infrastructure','reason':'Superseded by approved VF06 fixture assembly; original actor identity and functional light retained.'}
