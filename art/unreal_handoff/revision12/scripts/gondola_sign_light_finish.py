...
ls=unreal.get_editor_subsystem(unreal.LevelEditorSubsystem);assert not ls.is_in_play_in_editor();aa=unreal.get_editor_subsystem(unreal.EditorActorSubsystem);a=next(a for a in aa.get_all_level_actors() if isinstance(a,unreal.GondolaStatusSign));a.set_editor_property('unlit_strength',0);a.set_editor_property('lit_strength',11)
