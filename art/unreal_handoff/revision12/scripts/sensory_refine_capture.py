...
b=Path(__file__).resolve().parents[1];out=b/'sensory_refine'/'views';out.mkdir(parents=True,exist_ok=True)
...
shots=JOB.get('shots') or [['rear',(-10,-12,5.7),(-17,-31,0)],['approach',(-13,-17,5.7),(-31,-45,-1)],['front',(0,5.5,5.8),(0,34,-12)],['side',(16,-10,5.7),(30,-29,0)]]
...
s={'phase':'place','index':0,'next':time.monotonic()+35,'deadline':time.monotonic()+180,'images':[],'busy':False}
def end():
...
def tick(dt):
 ...
 try:
  ...
  if s['phase']=='place':
   unreal.StationMigrationLibrary.set_pie_render_size(1800,1000);p.character_movement.set_movement_mode(unreal.MovementMode.MOVE_FLYING)
