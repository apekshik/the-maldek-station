...
b=Path(__file__).resolve().parents[1];out=b/'gondola_mechanism'/'verified_views';out.mkdir(exist_ok=True);plan=json.loads((b/'gondola_route/plan.json').read_text());n=plan['nodes'][1]
