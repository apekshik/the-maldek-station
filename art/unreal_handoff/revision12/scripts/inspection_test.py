...
def run():
 ...
 demo=[o for o in objects if o.actor_has_tag('ParkingInspectionSample')]
 check('saved_parking_meter_exists',len(demo)==1)
 obj=demo[0]
 ...
 key('E');yield .8
 check('E_enters_inspection',comp.phase==unreal.StationInspectionPhase.INSPECTING)
