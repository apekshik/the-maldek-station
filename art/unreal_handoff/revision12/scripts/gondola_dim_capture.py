...
b=Path(__file__).resolve().parents[1];out=b/'gondola_route'/'dim_views';out.mkdir(exist_ok=True);plan=json.loads((b/'gondola_route/plan.json').read_text());n=plan['nodes'][1]
...
shots=[('01_first_arrival',[-44282.305975,18799.707568,10463.5],[-44282.305975,22327.707568,10468.5],0),('02_docked',[-44082.305975,18679.707568,10463.5],[-44282.305975,19279.707568,10468.5],0)]
