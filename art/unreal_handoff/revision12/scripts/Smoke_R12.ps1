param([switch]$UseDefaultMap, [int]$BenchmarkSeconds = 300)
...
$commands = "stat unit, obj list class=BP_ForestWalker_C, obj list class=SurfaceFootstepComponent, r.HighResScreenshotDelay 120, HighResShot 2560x1440 filename=$shotPath"
...
$checks = @{
 ...
 forest_game_mode=($text -match "Game class is 'BP_ForestGameMode_C'")
