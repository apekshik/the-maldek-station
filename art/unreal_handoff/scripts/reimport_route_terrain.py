...
at=unreal.AssetToolsHelpers.get_asset_tools();task=unreal.AssetImportTask();task.filename=str(OUT/'revision05/fbx/SM_R05_Local_Terrain.fbx');task.destination_path=ROOT+'/Meshes';task.automated=True;task.save=True;task.replace_existing=True
...
mat=lib.load_asset(ROOT+'/Materials/M_R05_Local_Terrain');mesh.set_material(0,mat);lib.save_loaded_asset(mesh)
