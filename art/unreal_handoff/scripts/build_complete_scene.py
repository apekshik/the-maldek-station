...
assert not lib.does_asset_exist(MAP),'Do not replace an existing review map'
assert levels.new_level_from_template(MAP,'/Game/MaldekRefinement/Maps/BlockOut_R04')
