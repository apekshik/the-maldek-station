...
OUT=Path(__file__).resolve().parents[1]/'revision07'/'final_renders';OUT.mkdir(exist_ok=True)
...
shots=[
 ...
 ('03_lower_deck_eye',[-44800,19400,10070],[-44450,18800,10030]),
 ('04_relay_approach',[-47182,20575,10518],[-48800,19900,10300]),
]
